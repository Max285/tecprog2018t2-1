...
class RecipientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post recipients_url, params: { recipient: { address: @recipient.address, age: @recipient.age, name: @recipient.name, relationship: @recipient.relationship } }
    end
  ...
  test "should update recipient" do
    patch recipient_url(@recipient), params: { recipient: { address: @recipient.address, age: @recipient.age, name: @recipient.name, relationship: @recipient.relationship } }
