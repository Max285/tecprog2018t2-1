...
class GiftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post gifts_url, params: { gift: { Date_to_send: @gift.Date_to_send, Image_url: @gift.Image_url, name: @gift.name } }
    end
  ...
  test "should update gift" do
    patch gift_url(@gift), params: { gift: { Date_to_send: @gift.Date_to_send, Image_url: @gift.Image_url, name: @gift.name } }
